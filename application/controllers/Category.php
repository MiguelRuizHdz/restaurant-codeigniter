...
class Category extends Admin_Controller 
{
	...
	public function create()
	{
		...
		$this->form_validation->set_rules('category_name', 'Nombre de categoría', 'trim|required');
	...
	public function update($id)
	{
		...
		if($id) {
			$this->form_validation->set_rules('edit_category_name', 'Nombre de categoría', 'trim|required');
	...
	public function remove()
	{
		...
		if($category_id) {
			...
			if($delete == true) {
				...
				$response['success'] = false;
				$response['messages'] = "Error en la base de datos al eliminar la información.";
			}
		}
		else {
			$response['success'] = false;
