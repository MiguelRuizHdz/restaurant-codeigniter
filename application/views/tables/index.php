        ...
        <div class="col-md-12 col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Gestión de mesas</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
      ...
      <form role="form" action="<?php echo base_url('tables/create') ?>" method="post" id="createForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="table_name" name="table_name" placeholder="Ingresa el nombre de la mesa" autocomplete="off">
          </div>

          <div class="form-group">
            <label for="brand_name">Capacidad</label>
            <input type="number" class="form-control" id="capacity" name="capacity" min="1" placeholder="Ingresa la capacidad" autocomplete="off">
          </div>
          ...
          <div class="form-group">
            <label for="active">Restaurante</label>
    ...
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('tables/update') ?>" method="post" id="updateForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="brand_name">Nombre de la mesa</label>
            <input type="text" class="form-control" id="edit_table_name" name="edit_table_name" placeholder="Ingresa el nombre de la mesa" autocomplete="off">
          </div>

          <div class="form-group">
            <label for="brand_name">Capacidad</label>
            <input type="number" class="form-control" id="edit_capacity" min="1" name="edit_capacity" placeholder="Ingresa la capacidad de la mesa" autocomplete="off">
          </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('tables/remove') ?>" method="post" id="removeForm">
        <div class="modal-body">
          <p>¿De verdad quieres eliminarla? </p>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-danger" data-dismiss="modal">Cerrar</button>
