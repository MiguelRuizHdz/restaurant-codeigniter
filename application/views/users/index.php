      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          ...
          <?php if(in_array('createUser', $user_permission)): ?>
            <a href="<?php echo base_url('users/create') ?>" class="btn btn-success">Agregar empleado</a>
            <br /> <br />
          <?php endif; ?>
                      ...
                      <tr>
                        ...
                        <td>
                          <?php if(in_array('updateUser', $user_permission)): ?>
                            <a href="<?php echo base_url('users/edit/'.$v['user_info']['id']) ?>" class="btn btn-info"><i class="fa fa-edit"></i></a>
                          <?php endif; ?>
