      ...
      <div class="row">
        ...
        <div class="col-md-12 col-xs-12">
          <form class="form-inline" action="<?php echo base_url('reports/') ?>" method="POST">
            ...
            <button type="submit" class="btn btn-default">Crear reporte</button>
          </form>
        </div>
        ...
        <div class="col-md-12 col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Total de pedidos pagados - Gráfica</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div class="chart">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Total de pedidos pagados - Reporte</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
