          ...
          <form role="form" action="<?php base_url('orders/create') ?>" method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="col-md-4 col-xs-12 pull pull-left">
                  ...
                  <div class="form-group">
                    <label for="gross_amount" class="col-sm-5 control-label" style="text-align:left;">Mesa</label>
                    <div class="col-sm-7">
                   ...
                   <tbody>
                     <tr id="row_1">
                       <td>
                        ...
                        <td><input type="number" name="qty[]" id="qty_1" class="form-control" min="1" max="100" required onkeyup="getTotal(1)" onchange="getTotal(1)"></td>
                        <td>
                ...
                <div class="col-md-6 col-xs-12 pull pull-right">
                  ...
                  <div class="form-group">
                    <label for="gross_amount" class="col-sm-5 control-label">Importe bruto</label>
                    <div class="col-sm-7">
                  ...
                  <div class="form-group">
                    <label for="service_charge" class="col-sm-5 control-label">Cargo por servicio: <?php echo $company_data['service_charge_value'] ?> %</label>
                    <div class="col-sm-7">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="number" class="form-control" id="discount" name="discount" placeholder="Descuento" onkeyup="subAmount()" autocomplete="off">
                    </div>
                  </div>
                  <div class="form-group">
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo base_url('orders/') ?>" class="btn btn-danger">Regresar</a>
              </div>
            </form>
          <!-- /.box-body -->
        </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    // var btnCust = '<button type="button" class="btn btn-secondary" title="Agregar etiquetas a la imagen" ' + 
    //     'onclick="alert(\'Contacta a tu administrador.\')">' +
               ...
               var html = '<tr id="row_'+row_id+'">'+
                   '<td>'+ 
                    '<select class="form-control select_group product" data-row-id="'+row_id+'" id="product_'+row_id+'" name="product[]" style="width:100%;" onchange="getProductData('+row_id+')">'+
                      ...
                      html += '</select>'+
                    '</td>'+ 
                    '<td><input type="number" name="qty[]" id="qty_'+row_id+'" class="form-control" min="1" max="100" onkeyup="getTotal('+row_id+')" onchange="getTotal('+row_id+')"></td>'+
  ...
  function getTotal(row = null) {
    if(row) {
      ...
      alert('No hay resultados, por favor actualice la página');
    }
  }

  // obtiene la información del producto del servidor
  function getProductData(row_id)
  {
    ...
    if(product_id == "") {
      ...
      $.ajax({
        ...
        dataType: 'json',
        success:function(response) {
          // establece el valor del precio en el campo de entrada del precio
      ...
      }); // /función ajax para recuperar los datos del producto
    }
  }
