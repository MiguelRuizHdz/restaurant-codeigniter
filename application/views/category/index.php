      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          ...
          <?php if(in_array('createCategory', $user_permission)): ?>
            <button class="btn btn-success" data-toggle="modal" data-target="#addModal">Agregar categorías</button>
            <br /> <br />
      ...
      <form role="form" action="<?php echo base_url('category/create') ?>" method="post" id="createForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="category_name" name="category_name" placeholder="Ingresa el nombre de la categoría" autocomplete="off">
          </div>
    ...
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('category/update') ?>" method="post" id="updateForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="brand_name">Nombre de la categoría</label>
            <input type="text" class="form-control" id="edit_category_name" name="edit_category_name" placeholder="Ingresa el nombre de la categoría" autocomplete="off">
          </div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title">Elimar categoría</h4>
      </div>
