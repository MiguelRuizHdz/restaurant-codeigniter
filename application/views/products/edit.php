          ...
          <form role="form" action="" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="product_name" name="product_name" placeholder="Ingresa el product nombre del producto" autocomplete="off" value="<?php echo !empty($this->input->post('product_name')) ?:$product_data['name'] ?>" />
                </div>

                <div class="form-group">
                  <label for="price">Precio</label>
                  <input type="number" class="form-control" id="price" name="price" placeholder="Ingresa el precio del producto" min="1" autocomplete="off" value="<?php echo !empty($this->input->post('price')) ?:$product_data['price'] ?>"/>
                </div>

                <div class="form-group">
                  <label for="description">Descripción</label>
                  <textarea type="text" class="form-control" id="description" name="description" placeholder="Ingresa el description" autocomplete="off"><?php echo !empty($this->input->post('description')) ?:$product_data['description'] ?>
                  </textarea>
                </div>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" id="active" name="active"> 
                    <option value="1" <?php if($product_data['active'] == 1) { echo 'selected="selected"'; } ?>>Sí</option>
