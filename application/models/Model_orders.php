...
class Model_orders extends CI_Model
{
	...
	// obtener los datos del artículo de pedidos
	...
	{
		$user_id = $this->session->userdata('id');
		// obtiene el id del restaurante del id del empleado 
		$user_data = $this->model_users->getUserData($user_id);
		$store_id = $user_data['store_id'];

		$bill_no = 'RSTRNT-'.strtoupper(substr(md5(uniqid(mt_rand(), true)), 0, 4));
    	$data = array(
    		'bill_no' => $bill_no,
	...
	public function update($id)
	{
		if($id) {
			...
			// ahora elimina los datos del artículo de pedido
	...
	// Elimina de la base de datos el pedido y los productos que estaban relacionados al pedido
	...
	// Cuenta el total de pedido pagados
	...
	// Cuenta el total de pedido no pagados
